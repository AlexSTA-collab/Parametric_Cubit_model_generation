...
def write_template_file(angle, height, output_dir="."):
    ...
    with open(inp_filename, "w") as f:
        ...
        f.write("\n*material, name=LINEARELASTICINTERFACE, id=ElasticInterfaceMaterial, provider = marmotmaterialhypoelasticinterface\n")
        f.write(f" **Isotropic\n** E_M, nu_M,  E_I, nu_I,  E_0, nu_0,   h, MaterialID\n $E_M, 0.3, $E_I, 0.3, $E_0, 0.3, $h, 0\n\n")
        ...
        f.write(f"*output, type=ensight, name=Cohesive_zone_model_interface_{height:g}\n")
        ...
        f.write(f"*output, type=ensight, name=Cohesive_zone_model_top_{height:g}\n")
        ...
        f.write(f"*output, type=ensight, name=Cohesive_zone_model_bottom_{height:g}\n")
        ...
        f.write("**nodeforces, name = topF,      nSet = top-Z+,  field=displacement, 1=1e-6, 2=0, 3=0, f(t)=t\n")
