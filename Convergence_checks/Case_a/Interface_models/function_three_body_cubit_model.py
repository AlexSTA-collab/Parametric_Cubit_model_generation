...
def generate_cubit_model(cut_angle, height_of_interphase_layer, output_dir="."):
    ...
    cubit.cmd("set tolerance geometry 1e-6")
    cubit.cmd("set merge tolerance 1e-10")
    cubit.cmd("set auto heal off")
    ...
    scale_factor = max(1.0, 1000.0 * model_size / gap)  # adaptive scale based on gap
    ...
    cubit.cmd(f"move volume {top_vol} x 0 y 0 z {1*gap * scale_factor} include_merged")
