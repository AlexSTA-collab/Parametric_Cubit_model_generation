...
def write_template_file(angle, height, output_dir="."):
    ...
    with open(inp_filename, "w") as f:
        ...
        f.write(f"*output, type=ensight, name=Cauchy_Full_model_interface_{height:g}\n")
        ...
        f.write(f"*output, type=ensight, name=Cauchy_Full_model_top_{height:g}\n")
        ...
        f.write(f"*output, type=ensight, name=Cauchy_Full_model_bottom_{height:g}\n")
