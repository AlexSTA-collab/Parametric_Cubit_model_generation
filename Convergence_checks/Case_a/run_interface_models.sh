...
POST_MODULE_1="Interface_Model_Evaluate_traction_jump"
POST_MODULE_2="Interface_Model_Evaluate_displacement_jump"

# Target subdirectory
SUBDIR="Interface_models"
...
run_case () {
  ...
  local case_bottom="${work_dir}/Cohesive_zone_model_bottom_${h}.case"
  local case_top="${work_dir}/Cohesive_zone_model_top_${h}.case"
