...
def plot_displacement_jump(points_bottom, displacement_jump, layer_height, angle_deg):
    """Plot displacement jump magnitude on structured grid or scatter plot."""
    tol = 1e-6
...
def compute_and_save_displacement_jump(
    ...
    layer_height : float
        Height of the layer between bottom and top (used for slicing planes)
    angle_deg : float
        Inclination angle (deg) of the interface around the Y-axis
    m : float
        Relaxation time of the Wiechert model
    n : float
        Elasticity of the Maxwell Element
    ...
    output_pkl = os.path.join(
        output_dir,
        f"displacement_jump_h{layer_height:.3f}_angle_{angle_deg:.1f}_m_{m:.3g}_n_{n:.3g}.pkl"
    )
    ...
    origin_slice1_bottom = [0.0, 0.0, -eps]
...
def main():
    ...
    """
    case_bottom = "/home/alexsta1993/Documents/STATHAS_VIENNA_POSTDOC/Applications_Examples/EdelweisModels/Cohesive_Zone_models/3D/Three_Body_Cubit/Comparizon_LinearElastic/Convergence_check/Case_a/Full_layer_models/Full_layer_Templates_angle_10/Tested_input_files_angle_10/Cauchy_Full_model_bottom_h_0.1.case"
    case_top = "/home/alexsta1993/Documents/STATHAS_VIENNA_POSTDOC/Applications_Examples/EdelweisModels/Cohesive_Zone_models/3D/Three_Body_Cubit/Comparizon_LinearElastic/Convergence_check/Case_a/Full_layer_models/Full_layer_Templates_angle_10/Tested_input_files_angle_10/Cauchy_Full_model_top_h_0.1.case"
    layer_height = 0.1
    angle_deg = 10
    m = 1e-3
    n = 4e4
