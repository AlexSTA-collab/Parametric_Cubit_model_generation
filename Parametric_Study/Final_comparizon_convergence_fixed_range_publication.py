...
# Point to the stiff family cases directories
FAMILY = "stiff"
ANGLE = 10
FULL_CASES = SCRIPT_DIR / FAMILY / f"angle_{ANGLE}" / "Full_layer_models_templates" / "cases"
INTERFACE_CASES = SCRIPT_DIR / FAMILY / f"angle_{ANGLE}" / "Interface_models_templates" / "cases"
OUT_DIR = SCRIPT_DIR / FAMILY / f"angle_{ANGLE}" / "comparison_results"
