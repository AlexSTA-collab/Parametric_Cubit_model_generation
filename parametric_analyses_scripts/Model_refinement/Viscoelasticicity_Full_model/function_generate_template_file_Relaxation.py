...
def write_template_file(angle, mesh_size, output_dir="."):
    ...
    inp_filename = root_dir / f"Maxwell_Template_Relaxation_three_body_model_angle_{angle:g}_n_{mesh_size:g}_Full_model.inp"
    ...
    with open(inp_filename, "w") as f:
        ...
        f.write("*material, name=LinearElastic, id=interface_body, provider = edelweissmaterial\n")
        ...
        f.write("*section, name=section3, material=interface_body, type=solid\n")
        f.write("interface-body\n\n")

        f.write("*job, name=Fulljob, domain=3d\n")
        ...
        f.write("dirichlet, name = bottom,   nSet = bottom-Z-,  field=displacement, 1=-0.1, 2=0, 3=0, f(t)=t\n")
        f.write("dirichlet, name = top,      nSet = top-Z+,  field=displacement, 1=0.1, 2=0, 3=0, f(t)=t\n\n")


        #second step keep displacement constant
        f.write("*step, solver=theSolver, maxInc=0.025, minInc=0.025, maxNumInc=1000, maxIter=1000, stepLength= 0.1\n")
        f.write("options, category=NISTSolver, extrapolation=off\n")
        f.write("dirichlet, name = bottom,   nSet = bottom-Z-,  field=displacement, 1=-0.1, 2=0, 3=0, f(t)=1\n")
        f.write("dirichlet, name = top,      nSet = top-Z+,  field=displacement, 1=0.1, 2=0, 3=0, f(t)=1\n")
