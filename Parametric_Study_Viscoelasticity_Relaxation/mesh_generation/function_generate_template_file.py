...
def write_template_file(angle, height, output_dir="."):
    ...
    inp_filename = root_dir / f"LinearViscoElastic_Interface_Template_three_body_model_angle_{angle:g}_h_{height:g}.inp"
    ...
    with open(inp_filename, "w") as f:
        ...
        f.write("\n*material, name=LINEARVISCOELASTICINTERFACE, id=ViscoElasticInterfaceMaterial, provider = marmotmaterialhypoelasticinterface\n")
        f.write("**Isotropic\n**")
        f.write("E_0, nu_0,   h, m,     n,  nKelvin,  minTau,  timeToDays,  MaterialID\n") 
        f.write(f" $E_0,  0.3,  $h, $m,   $n, $nKelvin, $minTau, $timeToDays, $MaterialID\n\n")
        ...
        f.write("*output, type=ensight, name=Cohesive_zone_model_interface_${h}\n")
        ...
        f.write("*output, type=ensight, name=Cohesive_zone_model_top_${h}\n")
        ...
        f.write("*output, type=ensight, name=Cohesive_zone_model_bottom_${h}\n")
        ...
        f.write("dirichlet, name = top, nSet = top-Z+, field=displacement, 1=1e-1, 2=0, 3=0, f(t)=t\n")
        #suplementary BCs to prvent bending
        ...
        #second step keep force constant and observe relaxation force stress
        f.write("*step, solver=theSolver, maxInc=0.025, minInc=0.025, maxNumInc=1000, maxIter=1000, stepLength=0.1\n")
        f.write("options, category=NISTSolver, extrapolation=off\n")
        f.write("dirichlet, name = bottom, nSet = bottom-Z-, field=displacement, 1=0, 2=0, 3=0, f(t)=t\n")
        f.write("dirichlet, name = top, nSet = top-Z+, field=displacement, 1=1e-1, 2=0, 3=0, f(t)=1\n")
        #suplementary BCs to prvent bending
        f.write("dirichlet, name = bottom-LX,   nSet = bottom-X-,  field=displacement, 2=0, 3=0, f(t)=t\n")
        f.write("dirichlet, name = bottom-RX,   nSet = bottom-X+,  field=displacement, 2=0, 3=0, f(t)=t\n")
        f.write("dirichlet, name = bottom-FY,   nSet = bottom-Y-,  field=displacement, 2=0, 3=0, f(t)=t\n")
